<%@ Page ClientIDMode="Static" Language="C#" Title="DrugProNET | Drug Information Query" AutoEventWireup="true" MasterPageFile="~/BasePage.Master" CodeBehind="DrugInfo.aspx.cs" Inherits="DrugProNET.DrugInfo" MaintainScrollPositionOnPostback="true" %>
