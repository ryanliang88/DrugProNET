<%@ Page ClientIDMode="Static" Title="DrugProNET | SNV ID Result" Language="C#" MasterPageFile="~/BasePage.Master" AutoEventWireup="true" CodeBehind="SNVIDResult.aspx.cs" Inherits="DrugProNET.SNVIDResult" %>
